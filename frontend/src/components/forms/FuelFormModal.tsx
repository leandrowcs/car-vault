...
export const FuelFormModal: React.FC<FuelFormModalProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={initialData ? 'Edit Fill-Up' : 'Log Fuel Fill-Up'}
      maxWidth="520px"
      footer={
        <>
          ...
          <button type="submit" form="fuel-form" className="btn btn-primary">
            {initialData ? 'Update Record' : 'Save Fill-Up'}
          </button>
        </>
      }
    >
      <form id="fuel-form" onSubmit={handleSubmit} style={{ display: 'grid', gap: '14px' }}>
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            <label className="form-label">Price per Liter ($ CAD/L)</label>
            <input
              type="number"
              step="0.001"
              min="0.01"
              className="form-input font-mono"
              placeholder="e.g. 1.589"
              value={pricePerLiter}
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              min="0.01"
              className="form-input font-mono"
              placeholder="Auto-calculated or type total"
              value={totalCost}
          ...
          <div className="form-group">
            <label className="form-label">Gas Station</label>
            <input
              type="text"
              className="form-input"
              placeholder="e.g. Petro-Canada, Shell, Costco"
              value={station}
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', padding: '6px 0' }}>
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            className="form-input"
            placeholder="Trip notes, fuel grade (87/91)..."
            value={notes}
