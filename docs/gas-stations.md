...
Open **Gas Stations** in the sidebar or mobile menu, or **Select nearby station** in the fuel form. A single browser location request starts the search. Without location access, enter latitude and longitude from a map application. City/address geocoding is not part of this MVP.
